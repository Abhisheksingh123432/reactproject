                  ...
                  <div className="row">
                      ...
                      <div className="col-md-3 mb-4 stretch-card transparent">
                        <div className="card card-tale">
                          <div className="card-body">
                            <p className="mb-4">Total Dealer</p>
                            <p className="fs-30 mb-2"> {count.dealerCount} </p>
                              {/* <p>10.00% (30 days)</p> */}
                          </div>
                        </div>
                      </div>
                    ...
                    {role === 3 ? (
                      <div className="col-md-3 mb-4 stretch-card transparent">
                        <div className="card card-tale">
                          <div className="card-body">
                            <p className="mb-4">Total Staff</p>
                            <p className="fs-30 mb-2">{count.staffCount}</p>
                            {/* <p>10.00% (30 days)</p> */}
                          </div>
                        </div>
                      </div>
                    ...
                    {role === 3 ? (
                      <div className="col-md-3 mb-4  stretch-card transparent">
                        <div className="card card-light-blue">
                          <div className="card-body">
                            <p className="mb-4">Number of Orders</p>
                            <p className="fs-30 mb-2">{count.orderCount}</p>
                            {/* <p>2.00% (30 days)</p> */}
                          </div>
                        </div>
                      </div>
                    ...
                    {role === 3 ? (
                      <div className="col-md-3  mb-4 stretch-card transparent">
                        <div className="card card-light-danger">
                          <div className="card-body">
                            <p className="mb-4">Number of Pending orders</p>
                            <p className="fs-30 mb-2">{count.PorderCount}</p>
                            {/*  <p>0.22% (30 days)</p> */}
                          </div>
                        </div>
                      </div>
                ...
                <div className="col-md-6 grid-margin stretch-card">
                  <div className="card">
                    <div className="card-body">
                      ...
                      <BarChart height={170} className="barchart1"/>
                ...
                <div className="col-md-6 grid-margin stretch-card">
                  <div className="card">
                    <div className="card-body">
                      ...
                      ></div>
                      {/* <canvas id="sales-chart"></canvas> */}<BarChart height={170} className="barchart1"/> 
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* <footer className="footer">
              <div className="d-sm-flex justify-content-center justify-content-sm-between">
                <span className="text-muted text-center text-sm-left d-block d-sm-inline-block">
                  ...
                  <a href="https://www.bootstrapdash.com/" target="">
              ...
              <div className="d-sm-flex justify-content-center justify-content-sm-between">
                <span className="text-muted text-center text-sm-left d-block d-sm-inline-block">
                  Distributed by{" "}
                  <a href="https://www.themewagon.com/" target="">
                    Themewagon
                  </a>
                </span>
              </div>
