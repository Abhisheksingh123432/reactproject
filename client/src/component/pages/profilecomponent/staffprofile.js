          ...
          <div class="card mb-3" style={{borderRadius: ".5rem"}}>
            <div class="row g-0">
              ...
              style={{borderTopLeftRadius: ".5rem; border-bottom-left-radius: .5rem;"}}>
                <img src={data.staff_image  ?`${config.backend_URL}/${data.staff_image}`: "https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava1-bg.webp"}
                  alt="Avatar" class="img-fluid my-5" style={{width: "80px"}} />
                <h5>{data.staff_name  ? data.staff_name: ""}</h5>
              ...
              <div class="col-md-8">
                <div class="card-body p-4">
                  ...
                  <div class="row pt-1">
                    ...
                    <h6>Name</h6>
                      <p class="text-muted">{data.staff_name  ? data.staff_name: ""}</p>
                    
                    
                    </div>
                    <div class="col-6 mb-3">
                    <h6>Email</h6>
                      <p class="text-muted">{data.staff_email  ? data.staff_email: ""}</p>
