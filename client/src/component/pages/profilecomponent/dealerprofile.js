          ...
          <div class="card mb-3" style={{borderRadius: ".5rem"}}>
            <div class="row g-0">
              ...
              style={{borderTopLeftRadius: ".5rem; border-bottom-left-radius: .5rem;"}}>
                <img src={data.Dealer_Image  ?`${config.backend_URL}/${data.Dealer_Image}`: "https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava1-bg.webp"}
                  alt="Avatar" class="img-fluid my-5" style={{width: "80px"}} />
                <h5>{data.Dealer_Name  ? data.Dealer_Name: ""}</h5>
              ...
              <div class="col-md-8">
                <div class="card-body p-4">
                  ...
                  <div class="row pt-1">
                    ...
                    <h6>Name</h6>
                      <p class="text-muted">{data.Dealer_Name  ? data.Dealer_Name: ""}</p>
                    
                      <h6>Phone number</h6>
                      <p class="text-muted">{data.Dealer_Number  ? data.Dealer_Number: ""}</p>
                      <h6>Pincode</h6>
                      <p class="text-muted">{data.Dealer_Pincode  ? data.Dealer_Pincode: ""}</p>
                    </div>
                    <div class="col-6 mb-3">
                    <h6>Email</h6>
                      <p class="text-muted">{data.Dealer_Email  ? data.Dealer_Email: ""}</p>
                      <h6>City</h6>
                      <p class="text-muted">{data.Dealer_City  ? data.Dealer_City: ""}</p>
                      <h6>Address</h6>
                      <p class="text-muted">{data.Dealer_Address  ? data.Dealer_Address: ""}</p>
                    </div>
                  </div>
                  <h6>Projects</h6>
                  <hr class="mt-0 mb-4"/>
