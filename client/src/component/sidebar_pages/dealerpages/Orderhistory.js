...
function OrderHistory() {
  ...
  const fetchData = () => {
    console.log(id);
    return setLoading(true) ,  fetch(`${config.backend_URL}/api/OrderHistoryData`)
  ...
  const renderAuthButton = (statusnum) => {
    if (statusnum==0) {
      return "In process";
    } else if(statusnum==1){
      return "Packing";
  ...
  return (<><Navigation/>{loadingInProgress ? <div className="parentdiv"><div className="loaderclsdiv"><ClipLoader className="loadercls" text-align="center" color={'#000'} loading={loadingInProgress}  size={35} /></div></div>: ""}
                            ...
                            <tr>
                              ...
                              <td>
                                {/*  <img
                                  ...
                                  alt="image"
                                /> */}
                                {orderdata.orderdata_productid
                                  ? orderdata.orderdata_productid
                                  : ""}
                              </td>
                              <td>
                                {orderdata.orderdata_productquantity
                                  ? orderdata.orderdata_productquantity
                                  : ""}
                                {/* <div class="progress">
                                  <div
                              ...
                              <td>
                                ...
                                <div class="form-group">
                                  ...
                                  {renderAuthButton(orderdata.orderdata_status)}
                                    
                                  </td>
                               {/*    { (orderdata.orderdata_status == 3) ? (true block) : ((condition2) ? (true block2) : (else block2))} */}
                                </div>
                                {/*   <button type="button" className="buttonedit" onClick={()=>deletedata(orderdata.order_id  ? orderdata.order_id: "")}>                   
                                  <AiFillDelete />
                                  Delete
                                </button> */}
                              </td>
