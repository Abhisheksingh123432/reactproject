...
function SDealerlist() {
  ...
  console.log("user", user);
    ...
    if (JSON.parse(localStorage.getItem("status")) == true) {
      ...
      const staffid=JSON.parse(localStorage.getItem("UserData"));
      setStaff(staffid.staff_id);
      console.log(staff)
      console.log("data is role staff:", staffid.staff_id);
                            ...
                            <tr>
                             ...
                             {/*  <td class="py-1">
                              ...
                              <img
                                  ...
                                  alt="image"
                                />
                                {userdata.Dealer_Name  ? userdata.Dealer_Name: ""}
                              </td>
                              <td>
                              {userdata.Dealer_City  ? userdata.Dealer_City: ""}
                                {/* <div class="progress">
                                  <div
                              ...
                              <td>
                                ...
                                <button type="button" className="buttonedit" onClick={()=>confirmit(userdata.Dealer_Id  ? userdata.Dealer_Id: "")}>
                                  <AiFillDelete />
                                  Delete
                                </button>
